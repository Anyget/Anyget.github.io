...
const PRE_TEMPLETES={
    "5ch": 
        {"lists":{"messages":{"deal_list":[],"style_list":[],"deal_sets":[]},"putmessagediv":{"deal_list":[],"style_list":[],"deal_sets":[]}},"all_data":{"liner_番号":{"dataset_adder":"1","dataset_adderm":true,"dataset_anchor":">>","dataset_fix?":true,"dataset_datalist?":false,"memo":{}},"liner_名前":{"dataset_adder":0,"dataset_adderm":false,"dataset_anchor":"","dataset_fix?":false,"dataset_datalist?":false,"memo":{}},"liner_メール":{"dataset_adder":0,"dataset_adderm":false,"dataset_anchor":"","dataset_fix?":false,"dataset_datalist?":false,"memo":{}},"blocker_本文":{"dataset_adder":0,"dataset_adderm":false,"dataset_anchor":"","dataset_fix?":false,"dataset_datalist?":false,"memo":{}}},"templates":[{"template":"$番号$：$名前$ [$メール$]\n|本文|","conf_htm":"<div class=\"$\"><input type=\"text\" class=\"$text liner_番号\" placeholder=\"番号\" value=\"\" list=\"list_liner_番号\" onscroll=\"linerscr(event)\"><div class=\"s_$text s_text\"></div></div>：<div class=\"$\"><input type=\"text\" class=\"$text liner_名前\" placeholder=\"名前\" value=\"\" list=\"list_liner_名前\" onscroll=\"linerscr(event)\"><div class=\"s_$text s_text\"></div></div> [<div class=\"$\"><input type=\"text\" class=\"$text liner_メール\" placeholder=\"メール\" value=\"\" list=\"list_liner_メール\" onscroll=\"linerscr(event)\"><div class=\"s_$text s_text\"></div></div>]<br><div class=\"|\"><textarea class=\"|text blocker_本文\" placeholder=\"本文\"onscroll=\"blockerscr(event)\"></textarea><div class=\"s_|text s_text\"></div></div>","conf_col":"<span style=\"color:#FF0000;\">$番号$</span>：<span style=\"color:#FF0000;\">$名前$</span> [<span style=\"color:#FF0000;\">$メール$</span>]\n<span style=\"color:#0000FF;\">|本文|</span>","conf_data":["liner_番号","liner_名前","liner_メール","blocker_本文"],"conf_label":[]}],"inputing":{"liner_番号":"1","liner_名前":"名無し","liner_メール":"sage","blocker_本文":"あ"},"now_temp":0,"all_label":{},"settings_now":{"views":{"colors":{"themeselect":0,"highlightcheck":false},"size":{"sortboxes":0}},"editor":{"interface":{"cmoverreverse":false,"harmelnsptag":{"tags":"b,i,s,u,ruby,rt,small,big,xsmall,xbig,center,right,left,link,id,ref,sup,sub,hr,font,bgcolor,boxbgcolor,bordercolor,boxbordercolor,edge,opacity,blur,snake,vib,box,text,table,marquee,blink,fade,telop,speak,transparent,white,gray,darkgray,black,brown,darkbrown,red,darkred,gold,orange,darkorange,green,darkgreen,blue,darkblue,purple,pink,color","unclosetags":"id,hr","autoclose":false}}},"outputs":{"plain":{"span":"\n\n","skip":"===\n","indentex":"「」","indentstr":"　","revindentex":"","revindentstr":"","replyindent":"","zenkaku":{"zenkakunumber":false,"zenkakualphabet":false,"zenkakusymbol":false}}}}},
    "twitter":
        {"lists":{"messages":{"deal_list":[],"style_list":[{"liner_名前":["width: 136px;"],"liner_スクリーンネーム":["width: 131px;"],"blocker_本文":[""],"liner_リツイート":["width: 56px;"],"liner_いいね":[""]}],"deal_sets":[]},"putmessagediv":{"deal_list":[],"style_list":[],"deal_sets":[]}},"all_data":{"liner_名前":{"dataset_adder":0,"dataset_adderm":false,"dataset_anchor":"","dataset_fix?":false,"dataset_datalist?":true,"memo":{}},"liner_スクリーンネーム":{"dataset_adder":0,"dataset_adderm":false,"dataset_anchor":"@","dataset_fix?":false,"dataset_datalist?":true,"memo":{}},"blocker_本文":{"dataset_adder":0,"dataset_adderm":false,"dataset_anchor":"","dataset_fix?":false,"dataset_datalist?":false,"memo":{}},"liner_リツイート":{"dataset_adder":0,"dataset_adderm":false,"dataset_anchor":"","dataset_fix?":false,"dataset_datalist?":false,"memo":{}},"liner_いいね":{"dataset_adder":0,"dataset_adderm":false,"dataset_anchor":"","dataset_fix?":false,"dataset_datalist?":false,"memo":{}}},"templates":[{"template":"$名前$ @$スクリーンネーム$\n|本文|\n%🔁%$リツイート$ %♥%$いいね$","conf_htm":"<div class=\"$\"><input type=\"text\" class=\"$text liner_名前\" placeholder=\"名前\" value=\"\" list=\"list_liner_名前\" onscroll=\"linerscr(event)\"><div class=\"s_$text s_text\"></div></div> @<div class=\"$\"><input type=\"text\" class=\"$text liner_スクリーンネーム\" placeholder=\"スクリーンネーム\" value=\"\" list=\"list_liner_スクリーンネーム\" onscroll=\"linerscr(event)\"><div class=\"s_$text s_text\"></div></div><br><div class=\"|\"><textarea class=\"|text blocker_本文\" placeholder=\"本文\"onscroll=\"blockerscr(event)\"></textarea><div class=\"s_|text s_text\"></div></div><span onclick=\"labelerclick(event)\" class=\"% labeler_🔁\">🔁</span><div class=\"$\"><input type=\"text\" class=\"$text liner_リツイート\" placeholder=\"リツイート\" value=\"\" list=\"list_liner_リツイート\" onscroll=\"linerscr(event)\"><div class=\"s_$text s_text\"></div></div> <span onclick=\"labelerclick(event)\" class=\"% labeler_♥\">♥</span><div class=\"$\"><input type=\"text\" class=\"$text liner_いいね\" placeholder=\"いいね\" value=\"\" list=\"list_liner_いいね\" onscroll=\"linerscr(event)\"><div class=\"s_$text s_text\"></div></div>","conf_col":"<span style=\"color:#FF0000;\">$名前$</span> @<span style=\"color:#FF0000;\">$スクリーンネーム$</span>\n<span style=\"color:#0000FF;\">|本文|</span>\n<span style=\"color:#FFFF00;\">%🔁%</span><span style=\"color:#FF0000;\">$リツイート$</span> <span style=\"color:#FFFF00;\">%♥%</span><span style=\"color:#FF0000;\">$いいね$</span>","conf_data":["liner_名前","liner_スクリーンネーム","blocker_本文","liner_リツイート","liner_いいね"],"conf_label":["labeler_🔁","labeler_♥"]}],"inputing":{"liner_名前":"名無し","liner_スクリーンネーム":"noname","blocker_本文":"あ","liner_リツイート":2,"liner_いいね":3},"now_temp":0,"all_label":{"labeler_🔁":{"labelset_calctarget":3,"labelset_calcstr":"","labelset_calcthen":"🔁","labelset_calcelse":"🔁","labelset_adder":"1"},"labeler_♥":{"labelset_calctarget":4,"labelset_calcstr":"","labelset_calcthen":"♥","labelset_calcelse":"♥","labelset_adder":"1"}},"settings_now":{"views":{"colors":{"themeselect":0,"highlightcheck":false},"size":{"sortboxes":0}},"editor":{"interface":{"cmoverreverse":false,"harmelnsptag":{"tags":"b,i,s,u,ruby,rt,small,big,xsmall,xbig,center,right,left,link,id,ref,sup,sub,hr,font,bgcolor,boxbgcolor,bordercolor,boxbordercolor,edge,opacity,blur,snake,vib,box,text,table,marquee,blink,fade,telop,speak,transparent,white,gray,darkgray,black,brown,darkbrown,red,darkred,gold,orange,darkorange,green,darkgreen,blue,darkblue,purple,pink,color","unclosetags":"id,hr","autoclose":false}}},"outputs":{"plain":{"span":"\n\n","skip":"","indentex":"","indentstr":"　","revindentex":"","revindentstr":"","replyindent":"　","zenkaku":{"zenkakunumber":false,"zenkakualphabet":false,"zenkakusymbol":false}}}}}
}
...
function changedatalist() {
    ...
    if (all_data[selecting]["dataset_datalist?"]){
        if (document.getElementById(`nlist_${selecting}`)!=null){
            document.getElementById(`nlist_${selecting}`).id = `list_${selecting}`
        }
    }else{
        if (document.getElementById(`list_${selecting}`)!=null){
